...
export class TabletopService {
  ...
  private rangeCache = new TabletopCache<Range>(() => ObjectStore.instance.getObjects(Range).filter(obj => obj.isVisibleOnTable));
  ...
  get ranges(): Range[] { return this.rangeCache.objects; }
