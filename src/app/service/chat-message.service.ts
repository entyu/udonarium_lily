...
export class ChatMessageService {
  ...
  sendMessage(chatTab: ChatTab, text: string, gameType: string, sendFrom: string, sendTo?: string, tachieNum?: number, color? :string): ChatMessage {//ñ{â∆Ç©ÇÁachieNum?: number color? :string Çí«â¡ 
...
//        let element = object.getElement('POS', object.detailDataElement);
        let element = object.detailDataElement.getFirstElementByName('POS'); //1.13.xÇ∆ÇÃmargeÇ≈èCê≥
        if(element)
