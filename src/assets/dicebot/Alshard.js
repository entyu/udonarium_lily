...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.const_set($nesting[0], 'NAME', "アルシャード");
    Opal.const_set($nesting[0], 'SORT_KEY', "あるしやあと");
    Opal.const_set($nesting[0], 'ID', "Alshard");
    self.$setPrefixes(["2D6.*", "AL.*"]);
    return self.$set_aliases_for_srs_roll("AL");
